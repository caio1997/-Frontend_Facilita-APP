...
export default function Anunciar({ route, navigation }) {
    ...
    <View style={styles.principal}>
      ...
      <View style={{ height: '50%', alignItems: 'center', top: 70 }}>
        <Button
          ...
          onPress={() => navigation.navigate("PublicarAnuncio", { item: "CELULAR", idClient: idClient, localizacao: localizacao })}
        />
        ...
        <Button
          ...
          onPress={() => navigation.navigate("PublicarAnuncio", { item: "NOTEBOOK", idClient: idClient, localizacao: localizacao })}
        />
